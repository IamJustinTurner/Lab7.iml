...
/**
 * Rock, Paper, Scissors, Lizard, Spock - Base Class for GamePlay
...
public class RPSLSpock {
     ...
     * @author Justin Turner
     *Constructor
     * @param pick - valid selection from (Rock, Paper, Scissors, Lizard, or Spock)
     * @return returns true if the value was one of the valid selections
     */
    ...
    /**
     * @return - Generates and returns a random string from one of the selections (ROCK, PAPER, SCISSORS, LIZARD, SPOCK)
     */
    ...
    /**
     * @param c_pick - Computer Choice (Randomly generated)
     * @param h_pick - User Choice
     * @return - Who wins (True if computer wins, otherwise, false.)
     */
